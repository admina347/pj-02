    ...
    public partial class SampleDataSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1929, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Мастер и Маргарита", 1 },
                    { 2, new DateTime(1925, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Собачье сердце", 1 },
                    { 3, new DateTime(1928, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Двенадцать стульев", 2 },
                    { 4, new DateTime(1842, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Мёртвые души", 2 },
                    { 5, new DateTime(1844, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Граф Монте-Кристо", 3 },
                    { 6, new DateTime(1931, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Золотой теленок", 4 },
                    { 7, new DateTime(1936, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Три товарища", 9 },
                    { 11, new DateTime(1825, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Евгений Онегин", 1 },
                    { 13, new DateTime(1831, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Повести Белкина", 2 },
                    { 14, new DateTime(1860, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Отцы и дети", 8 },
                    { 16, new DateTime(1892, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Палата № 6", 7 },
                    { 19, new DateTime(1868, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Идиот", 2 },
                    { 21, new DateTime(1855, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Рудин", 1 },
                    { 25, new DateTime(1836, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Капитанская дочка", 1 }
                });
